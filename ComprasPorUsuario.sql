...
END;
-- VOY A INTENTAR 
-- CÓDIGO COMO DIOS MANDA, DELEGADO POR PARTE DE VERO -- github.com/vmhgarcia2
...
--                        DBMS_OUTPUT.PUT_LINE('Usuario: ' || usuario.CUSTOMER_ID || '. Número de compras: ' || tickets.NUM_COMPRAS || '. Total compras: ' || tickets.TOTAL);                     
--                    END LOOP;         
--                CLOSE misTickets;
--            end loop;
--            
